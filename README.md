...
- 🔍 **多源聚合**：24 个搜索源（Knaben、TPB API、海盗湾HTML、海盗湾、RARBG、TorrentGalaxy、FileMood、EZTV、YTS、喵磁力、x磁搜、BtFox、种子吧等）
...
各源域名由 `check_domains.py` 自动探测（含跳转跟随：x磁搜、BtFox、种子吧等），探测失败时自动保留上次可用域名。
